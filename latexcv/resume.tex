...
\begin{entrylist}
  \entry
    ...
    {YOMA Bank}
    { \begin{itemize}
      \item Lead and Manage DevOps team and SRE team, VMWare, System Team, DBA Team and ApplicationRelease team
      \item Solution Architect for many applications and system.
      \item Responsible for managing all IT infrastructure platform, including Kubernetes, Oracle Servers, VMWare Servers
      \end{itemize}
    }
  \entry
    {Mar/19 - Aug/20}
...
\begin{entrylist}
  ...
  {DevOps}
  {  \begin{itemize}
      \item Very well experienced with Kubernetes, ISTIO, mTLS, Service Mesh
    \end{itemize}}
  \entry
  {Messaging}
